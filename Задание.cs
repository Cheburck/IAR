...
namespace Курсовая
{
    public partial class Ориентированный : Form
    {
        Form1 otec;
        Graph graph;
        DrawGraph drawGraph;
        ...
        bool end = true;
        DagProduct product;
        public Ориентированный(DagProduct product, Form1 form1)
        {
            InitializeComponent();
            otec = form1;
        ...
        private void button1_Click(object sender, EventArgs e) //start
        {
            ...
            else
            {
                ...
                int i = 0;
                while (i != Program.size)               //задание и отрисовка вершин графа
                {
